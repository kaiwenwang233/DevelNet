...
import glob
files = [f for f in glob.glob('/data/beroza/kaiwenw/Geysers/FilmDataDetection/test_pred_197301_0828224334mod8/results/' + "*.npz", recursive=True)]
file = open('/data/beroza/kaiwenw/Geysers/FilmDataDetection/test_pred_197301_0828224334mod8/picksfile.txt','a') 
for ifile in range(len(files)):
    preds=np.load('/data/beroza/kaiwenw/Geysers/FilmDataDetection/test_pred_197301_0828224334mod8/results/'+files[ifile].split('/')[-1][0:-4]+'.npz')
